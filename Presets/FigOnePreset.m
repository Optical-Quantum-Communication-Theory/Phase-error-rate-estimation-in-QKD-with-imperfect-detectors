...
%% Parameters
qkdInput.addFixedParameter("DeltaLoss", InputValues(:,1));
qkdInput.addFixedParameter("DeltaDarkCounts", InputValues(:,2));

lossdB = linspace(0,40,30);
eta = 10.^(-lossdB/10);
...
qkdInput.addFixedParameter("randomSwapFlag", InputValues(3)); 
