function qkdInput = FigOnePreset(InputValues)
...
%% Parameters
qkdInput.addFixedParameter("DeltaLoss", InputValues(2));
qkdInput.addFixedParameter("DeltaDarkCounts", InputValues(3));

lossdB = linspace(0,40,35);
eta = 10.^(-lossdB/10);
qkdInput.addScanParameter("eta", num2cell(eta));
...
qkdInput.addFixedParameter("randomSwapFlag", InputValues(4)); 
