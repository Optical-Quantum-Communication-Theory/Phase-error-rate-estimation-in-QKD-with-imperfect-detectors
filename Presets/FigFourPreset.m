function qkdInput = FigFourPreset(N)
...
qkdInput.addScanParameter("DeltaLoss", num2cell( linspace(0.00, 0.05, 50)) )
qkdInput.addScanParameter("DeltaDarkCounts", num2cell( linspace(0.00, 0.05, 50)) )


%DeltaDarkCounts is set to DeltaLoss in KeyRateFunc if it is not supplied
...
qkdInput.addFixedParameter("randomSwapFlag", 0); 
